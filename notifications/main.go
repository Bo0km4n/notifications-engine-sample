	...
	var command = cobra.Command{
		...
		Run: func(c *cobra.Command, args []string) {
			...
			certClient := dynamic.NewForConfigOrDie(restConfig).Resource(schema.GroupVersionResource{
				Group: "dummy.example.org", Version: "v1", Resource: "foos",
			})
